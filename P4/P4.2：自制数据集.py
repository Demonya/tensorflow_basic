#   训练数据：mnist_train_jpg_60000.txt   测试数据：mnist_train_jpg_60000.txt
#   example： 0_5.jpg  5
#             1_0.jpg  0
#             2_4.jpg  4
#             3_1.jpg  1
...
if os.path.exists(x_train_savepath) and os.path.exists(y_train_savepath) and os.path.exists(x_test_savepath) and os.path.exists(y_test_savepath):
    ...
    x_train, y_train = generateds(path=train_path, txt=train_txt)
    x_test, y_test = generateds(path=test_path, txt=test_txt)
